...
- **Usuario:**
  ...
  - **Treinador** — visualiza avaliacoes do Aluno vinculado cujo perfil abriu; pode **Excluir** (qualquer status) e **alterar** via **"Editar"** (Solicitada/Em andamento) ou **"Revisar"** (Concluida).
- **Pre-condicoes:** Usuario autenticado e com acesso aquela avaliacao.
- **Permissoes especiais:** Visualizar e sempre permitido para ambos. **"Excluir"** aparece **somente para o Treinador** (qualquer status). O botao de alterar aparece para o **Treinador** sempre, rotulado **"Editar"** (Solicitada/Em andamento) ou **"Revisar"** (Concluida — edita no lugar). **"Preencher"** aparece para o **Aluno** quando o status e **Solicitada**.
...
- Conteudo: Botao voltar + Titulo com o **tipo** + **data** + **status** (ex: "Antropometrica • 12/03/2026 • Concluida") usando o icone/cor do tipo (mesma identidade do card). Acoes a direita: para o **Treinador**, **menu ⋮** (Excluir) sempre e o botao de alterar (lapis) rotulado **"Editar"** (Solicitada/Em andamento) ou **"Revisar"** (Concluida); para o **Aluno** em avaliacao **Solicitada**, **"Preencher"**.
...
### 3.3 Footer / Rodape
- Conteudo: Acoes contextuais — **"Editar"/"Revisar"** (somente Treinador; "Revisar" em Concluida) ou **"Preencher"** (Aluno, se Solicitada) e, opcionalmente, **"Ver evolucao"** (grafico do tipo) quando essa tela existir.
...
- Para o **Aluno**, "Editar" e "Excluir" ficam **ocultos**; a tela permanece em leitura (com "Preencher" apenas se Solicitada).
...
| Cadastro/Edicao `[VELA-2003]` | Apos salvar (fluxo alternativo — a confirmar) |
...
| Evolucao / Graficos (futuro) | Toca em "Ver evolucao" (quando existir) |
